    ...
    <>
      ...
      <main className="container mx-auto mt-24 flex min-h-screen flex-col gap-4 px-8">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to icons.ben-t.dev, the
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to icons.ben-t.dev.
            </p>
          </li>
          <li>
            <p>
        ...
        <ul>
          <li>
            <p>By email: benjaminctyner@gmail.com</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="icons.ben-t.dev/privacyPolicy"
                rel="external nofollow noopener"
                target="_blank"
              >
                icons.ben-t.dev/privacyPolicy
              </a>
            </p>
          </li>
        </ul>
